...
The exponetial complexity of Generic algorithm could come from bad choices of edges, which is impossible to know what a good choice is without brute-force...But practically there is no better choice for that situation. For most common problems, we can use Dijkstra or Bellman-Ford.
