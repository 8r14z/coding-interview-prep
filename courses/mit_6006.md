...
**Load factor**
The performance of the hash table deteriorates in relation to the load factor {\displaystyle \alpha }\alpha. Therefore a hash table is resized or rehashed if the load factor {\displaystyle \alpha }\alpha  approaches 1. A table is also resized if the load factor drops below {\displaystyle \alpha _{max}/4}{\displaystyle \alpha _{max}/4}. Acceptable figures of load factor {\displaystyle \alpha }\alpha  include 0.6 and 0.75.
